    ...
    <header className="w-[7.2rem] py-6 h-full flex flex-col justify-between">
      ...
      <div className="h-[7.2rem] rounded-lg bg-gray-900 flex items-center justify-center">
        <div className="w-11 cursor-pointer group">
          <div className="w-9/12 h-[0.24rem] bg-gray-100 transition-width duration-300 group-hover:w-full group-hover:bg-main-orange"></div>
          <div className="w-full h-1 bg-gray-100 my-2 group-hover:bg-main-orange"></div>
          <div className="w-9/12 h-[0.24rem] bg-gray-100 transition-width duration-300 group-hover:w-full group-hover:bg-main-orange"></div>
        </div>
      </div>
      ...
      <div className="h-[7.2rem] rounded-lg bg-gray-900 flex items-center justify-center">
        <div className="relative cursor-pointer">
          <BsCartFill className="text-4xl text-gray-100" />
